...
const vocabulary = [
  ...
  { bima: "Ninu"      , indonesia: "Minum" },
  { bima: "Turo"      , indonesia: "Tidur" },
  { bima: "Lao"       , indonesia: "Pergi" },
  { bima: "Mai"       , indonesia: "Datang" },
  { bima: "Dula"      , indonesia: "Pulang" },
  { bima: "Doko"      , indonesia: "Duduk" },
  { bima: "Nggahi"    , indonesia: "Bicara" },
  { bima: "Bongi"     , indonesia: "Mau/Ingin" },
  { bima: "Uma"       , indonesia: "Rumah" },
  { bima: "Dana"      , indonesia: "Tanah/Kampung" },
  ...
  { bima: "Wa'i"      , indonesia: "Nenek" },
  { bima: "Ana"       , indonesia: "Anak" },
  { bima: "Pasa"      , indonesia: "Pasar" },
  { bima: "Taho"      , indonesia: "Baik/Bagus" },
  { bima: "Na'e"      , indonesia: "Besar" },
  { bima: "To'i"      , indonesia: "Kecil" },
  { bima: "Wati"      , indonesia: "Tidak" },
  { bima: "Iyo"       , indonesia: "Iya" },
  { bima: "Au taho?"  , indonesia: "Apa kabar?" },
  { bima: "Ba au?"    , indonesia: "Kenapa?" },
  { bima: "Pira?"     , indonesia: "Berapa?" },
  { bima: "Di dampa?" , indonesia: "Di mana?" },
...
=================================================== */
const sentences = [
  { bima: "Au taho nggomi?"         , indonesia: "Apa kabar kamu?" },
  { bima: "Nahu taho ya salam."     , indonesia: "Saya baik-baik saja terima kasih." },
  { bima: "Assalamu'alaikum."       , indonesia: "Assalamu'alaikum (Salam sejahtera)." },
  { bima: "Wa'alaikumsalam."        , indonesia: "Wa'alaikumsalam (Balasan salam)." },
  { bima: "Selamat wura."           , indonesia: "Selamat pagi." },
  { bima: "Selamat lopi."           , indonesia: "Selamat sore." },
  { bima: "Selamat mori."           , indonesia: "Selamat malam." },
  { bima: "Nahu lao ku uma."        , indonesia: "Saya pergi ke rumah." },
  { bima: "Nahu bongi ngaha."       , indonesia: "Saya mau makan." },
  { bima: "Nahu bongi ninu oi."     , indonesia: "Saya mau minum air." },
  { bima: "Nahu ncara Bima."        , indonesia: "Saya berasal dari Bima." },
  { bima: "Ipi cou nggomi?"         , indonesia: "Siapa nama kamu?" },
  { bima: "Cou nahu Ahmad."         , indonesia: "Nama saya Ahmad." },
  { bima: "Di dampa nggomi ncara?"  , indonesia: "Dari mana kamu berasal?" },
  { bima: "Pira umur nggomi?"       , indonesia: "Berapa umur kamu?" },
  { bima: "Nahu umur rompulu mbali.", indonesia: "Saya berumur dua puluh tahun." },
  { bima: "Nggomi lao di dampa?"    , indonesia: "Kamu pergi ke mana?" },
  { bima: "Nahu lao ku pasa."       , indonesia: "Saya pergi ke pasar." },
  { bima: "Ina nahu taho."          , indonesia: "Ibu saya baik." },
  { bima: "Ama nahu lao ku uma."    , indonesia: "Ayah saya pergi ke rumah." },
  { bima: "Ana nahu doko di uma."   , indonesia: "Anak saya duduk di rumah." },
  { bima: "Ompu nahu ngaha nahu."   , indonesia: "Kakek saya sudah makan." },
  { bima: "Wa'i nahu nggahi taho."  , indonesia: "Nenek saya berbicara dengan baik." },
  { bima: "Sia ana ku uma."         , indonesia: "Dia anak di rumah." },
  { bima: "Nahu turo na'e."         , indonesia: "Saya sangat mengantuk / tidur nyenyak." },
  { bima: "Nahu wati bongi lao."    , indonesia: "Saya tidak mau pergi." },
  { bima: "Nggomi doko di di dampa?", indonesia: "Kamu duduk di mana?" },
  { bima: "Sia mai ku uma nahu."    , indonesia: "Dia datang ke rumah saya." },
  { bima: "Nahu dula mai uma."      , indonesia: "Saya pulang ke rumah." },
  { bima: "Nahu nggahi sama sia."   , indonesia: "Saya berbicara dengannya." },
  { bima: "Ba au nggomi wati mai?"  , indonesia: "Kenapa kamu tidak datang?" },
  { bima: "Au bongi nggomi?"        , indonesia: "Apa yang kamu inginkan?" },
  { bima: "Pira harga au ndi?"      , indonesia: "Berapa harga ini?" },
  { bima: "Di dampa uma nggomi?"    , indonesia: "Di mana rumah kamu?" },
  { bima: "Cou mai ku uma nahu?"    , indonesia: "Siapa yang datang ke rumah saya?" },
  { bima: "Nahu ringa na'e."        , indonesia: "Saya sangat senang." },
  { bima: "Nahu loa na'e."          , indonesia: "Saya sangat lapar." },
  { bima: "Uma nahu na'e."          , indonesia: "Rumah saya besar." },
  { bima: "Uma nggomi to'i."        , indonesia: "Rumah kamu kecil." },
  { bima: "Dana Bima taho na'e."    , indonesia: "Kampung Bima sangat indah." },
  { bima: "Oi ndi sari."            , indonesia: "Air ini segar." },
  { bima: "Iyo nahu ngerti."        , indonesia: "Iya saya mengerti." },
  { bima: "Wati nahu wati ngerti."  , indonesia: "Tidak saya tidak mengerti." },
  { bima: "Terima kasih na'e."      , indonesia: "Terima kasih banyak." },
  ...
  { bima: "Nggo Wati Tahu Ngaha"    , indonesia: "Kamu Jangan Makan Anjing" },
  { bima: "Nggo wati doko"          , indonesia: "kamu jangan duduk" },
];
